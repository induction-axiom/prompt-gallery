...
const variants = {
    primary: "bg-transparent border border-firebase-orange text-gray-900 dark:text-white hover:bg-firebase-orange hover:text-gray-900 dark:hover:text-gray-900 shadow-sm transition-all",
